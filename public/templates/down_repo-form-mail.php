<div id="alertlink">
	<p><?php _e('You will receive an email alert ONLY when a new version will be available','down_repo') ?></p>
	<form action="add_alert_down" method="post" id="newAlertForm">
		<div class="input-group">
			...
			<span class="input-group-btn"><button class="btn btn-warning" type="submit"><?php _e('Register','down_repo') ?></button></span>
		</div>
	</form>
